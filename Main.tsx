...
const Main: React.FC = () => {
  ...
  // Navigate to Obfuscator
  const handleNavigateToObfuscator = () => {
    setView(AppView.OBFUSCATOR);
  };

  // Navigate Back to Dashboard from Obfuscator
  ...
  switch (view) {
    ...
    case AppView.DASHBOARD:
      return <Dashboard onSimulate={handleSimulate} onNavigateToObfuscator={handleNavigateToObfuscator} />;
      
    case AppView.OBFUSCATOR:
      return <Obfuscator onBack={handleBackToDashboard} />;
